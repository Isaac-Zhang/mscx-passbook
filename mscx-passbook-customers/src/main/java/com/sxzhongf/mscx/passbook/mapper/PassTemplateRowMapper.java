...
/**
 * PassTemplateRowMapper for PassTemplate ORM映射
 *
...
public class PassTemplateRowMapper implements RowMapper<PassTemplateVO> {
    ...
    // 定义HBase PassTemplate 表的列族B中的字节定义
    ...
    // 定义HBase PassTemplate 表的列族C中的字节定义
    ...
    public PassTemplateVO mapRow(Result result, int rowNum) throws Exception {
        ...
        PassTemplateVO passTemplate = new PassTemplateVO();
